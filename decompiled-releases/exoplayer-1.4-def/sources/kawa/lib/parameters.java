...
public class parameters extends ModuleBody {
    ...
    static {
        ...
        $Prvt$parameterize$Pc = Macro.make(simpleSymbol9, syntaxRules3, parameters);
        parameterize = Macro.make(simpleSymbol10, syntaxRules2, parameters);
        parameters.run();
    }
