...
class NotificationCompatJellybean {
    ...
    static NotificationCompat.Action getActionFromBundle(Bundle bundle) {
        ...
        return new NotificationCompat.Action(bundle2.getInt("icon"), bundle2.getCharSequence(KEY_TITLE), (PendingIntent) bundle2.getParcelable(KEY_ACTION_INTENT), bundle2.getBundle(KEY_EXTRAS), fromBundleArray(getBundleArrayFromBundle(bundle2, KEY_REMOTE_INPUTS)), fromBundleArray(getBundleArrayFromBundle(bundle2, KEY_DATA_ONLY_REMOTE_INPUTS)), allowGeneratedReplies, bundle2.getInt(KEY_SEMANTIC_ACTION), bundle2.getBoolean(KEY_SHOWS_USER_INTERFACE), false, false);
    }
