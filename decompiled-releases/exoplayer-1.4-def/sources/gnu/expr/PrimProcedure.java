...
public class PrimProcedure extends MethodProc implements Inlineable {
    ...
    public int isApplicable(Type[] argTypes2) {
        ...
        if (app != -1 || (method2 = this.method) == null || (method2.getModifiers() & 128) == 0 || nargs <= 0 || !(argTypes2[nargs - 1] instanceof ArrayType)) {
            return app;
        }
    ...
    public PrimProcedure(Method method2, char mode2, Language language) {
        ...
        if (isConstructor()) {
            ...
            Type langTypeFor = language.getLangTypeFor(method2.getReturnType());
    ...
    private void compileArgs(Expression[] args, int startArg, Type thisType, Compilation comp) {
        ...
        while (true) {
            ...
            if (i < nargs) {
                ...
                expressionArr[startArg + i].compileNotePosition(compilation, lambdaExp2 == null ? CheckedTarget.getInstance(argTypeForTarget, name, i + 1) : CheckedTarget.getInstance(argTypeForTarget, lambdaExp2, i), expressionArr[startArg + i]);
                if (createVarargsNow) {
    ...
    public void compile(ApplyExp exp, Compilation comp, Target target) {
        ...
        ClassType mclass = method2 == null ? null : method2.getDeclaringClass();
    ...
    public void compile(Type thisType, ApplyExp exp, Compilation comp, Target target) {
        ...
        if (isConstructor()) {
            Method method2 = this.method;
            if (method2 != null) {
                mclass = method2.getDeclaringClass();
            }
            ...
            if (method3 != null) {
                mclass = method3.getDeclaringClass();
            }
        ...
        compileInvoke(comp, method4, target, exp.isTailCall(), this.op_code, stackType);
    }
    ...
    public String getVerboseName() {
        ...
        if (method2 == null) {
            ...
            buf.append(method2.getDeclaringClass().getName());
            buf.append('.');
