...
public class LispReader extends Lexer {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:165:0x0273, code lost:
        if (r7[r4 + 2] == 'n') goto L_0x0277;
     */
    /* JADX WARNING: Removed duplicated region for block: B:168:0x0279 A[RETURN] */
    ...
    public static java.lang.Object parseNumber(char[] r26, int r27, int r28, char r29, int r30, int r31) {
        ...
        L_0x0235:
            ...
            int r15 = r4 + 1
            char r15 = r7[r15]
            if (r15 != r10) goto L_0x0265
            int r15 = r4 + 2
            char r15 = r7[r15]
            r14 = 102(0x66, float:1.43E-43)
            if (r15 != r14) goto L_0x0265
        ...
        L_0x0365:
            ...
            r2 = r3
        L_0x036a:
            if (r13 == r10) goto L_0x0373
            r1 = 69
            if (r13 != r1) goto L_0x0371
            goto L_0x0373
        L_0x0371:
            r6 = r2
            goto L_0x0378
        ...
        L_0x03c9:
            int r11 = r11 + 1
            if (r1 != r8) goto L_0x03ee
        L_0x03ce:
            r0 = 1
            if (r11 != r0) goto L_0x03eb
            int r0 = r1 + -1
            char r0 = r7[r0]
            r2 = 105(0x69, float:1.47E-43)
        ...
        L_0x0444:
            ...
            switch(r0) {
                case 100: goto L_0x045f;
                case 102: goto L_0x0459;
                case 108: goto L_0x0454;
                case 115: goto L_0x0459;
