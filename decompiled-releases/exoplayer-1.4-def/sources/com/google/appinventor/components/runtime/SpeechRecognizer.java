...
public class SpeechRecognizer extends AndroidNonvisibleComponent implements Component, OnClearListener, SpeechListener {
    ...
    @SimpleFunction
    public void Stop() {
        SpeechRecognizerController speechRecognizerController2 = this.speechRecognizerController;
        if (speechRecognizerController2 != null) {
            speechRecognizerController2.stop();
        }
    }
