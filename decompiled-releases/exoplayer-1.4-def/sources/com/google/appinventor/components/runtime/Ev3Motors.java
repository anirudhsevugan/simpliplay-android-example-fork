...
public class Ev3Motors extends LegoMindstormsEv3Base {
    ...
    private void outputStepSync(String functionName, int layer, int nos, int speed, int turnRatio, int tachoCounts, boolean brake) {
        ...
        String str2 = functionName;
        sendCommand(str2, Ev3BinaryParser.encodeDirectCommand(Ev3Constants.Opcode.OUTPUT_STEP_SYNC, false, 0, 0, "cccccc", Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) roundValue(speed, -100, 100)), Short.valueOf((short) i3), Integer.valueOf(tachoCounts), Byte.valueOf(brake ? (byte) 1 : 0)), false);
    }
    ...
    private void outputTimeSync(String functionName, int layer, int nos, int speed, int turnRatio, int milliseconds, boolean brake) {
        ...
        String str2 = functionName;
        sendCommand(str2, Ev3BinaryParser.encodeDirectCommand(Ev3Constants.Opcode.OUTPUT_TIME_SYNC, false, 0, 0, "cccccc", Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) roundValue(speed, -100, 100)), Short.valueOf((short) turnRatio), Integer.valueOf(milliseconds), Byte.valueOf(brake ? (byte) 1 : 0)), false);
    }
