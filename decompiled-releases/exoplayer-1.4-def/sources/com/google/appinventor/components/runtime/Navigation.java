...
public class Navigation extends AndroidNonvisibleComponent implements Component {
    ...
    public void performRequest(org.osmdroid.util.GeoPoint r26, org.osmdroid.util.GeoPoint r27, com.google.appinventor.components.common.TransportMethod r28) throws java.io.IOException, org.json.JSONException {
        /*
            ...
            java.lang.Object[] r4 = new java.lang.Object[r6]     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            int r6 = r14.getResponseCode()     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            r4[r3] = r6     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            java.lang.String r6 = r14.getResponseMessage()     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            r4[r15] = r6     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            r6 = 4003(0xfa3, float:5.61E-42)
            r0.dispatchErrorOccurredEvent(r10, r11, r6, r4)     // Catch:{ Exception -> 0x00c5, all -> 0x00be }
            r14.disconnect()
            return
        L_0x00be:
            r0 = move-exception
        ...
        L_0x019a:
            ...
            r2 = 1
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ all -> 0x01b2 }
            java.lang.String r3 = r0.getMessage()     // Catch:{ all -> 0x01b2 }
            r2[r13] = r3     // Catch:{ all -> 0x01b2 }
            r3 = 4002(0xfa2, float:5.608E-42)
            r1.dispatchErrorOccurredEvent(r10, r11, r3, r2)     // Catch:{ all -> 0x01b2 }
