...
public class ContactPicker extends Picker implements ActivityResultListener {
    ...
    public void resultReturned(int r13, int r14, android.content.Intent r15) {
        ...
        L_0x0034:
            ...
            r9 = 0
            r10 = 0
            int r2 = com.google.appinventor.components.runtime.util.SdkLevel.getLevel()     // Catch:{ Exception -> 0x00da }
            if (r2 < r4) goto L_0x0074
            java.lang.String[] r2 = com.google.appinventor.components.runtime.util.HoneycombMR1Util.getContactProjection()     // Catch:{ Exception -> 0x00da }
            CONTACT_PROJECTION = r2     // Catch:{ Exception -> 0x00da }
            android.app.Activity r2 = r12.activityContext     // Catch:{ Exception -> 0x00da }
            android.content.ContentResolver r2 = r2.getContentResolver()     // Catch:{ Exception -> 0x00da }
            java.lang.String[] r4 = CONTACT_PROJECTION     // Catch:{ Exception -> 0x00da }
            r5 = 0
            r6 = 0
            r7 = 0
            r3 = r0
            android.database.Cursor r2 = r2.query(r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x00da }
            r9 = r2
            java.lang.String r2 = r12.postHoneycombGetContactNameAndPicture(r9)     // Catch:{ Exception -> 0x00da }
            java.lang.String[] r3 = com.google.appinventor.components.runtime.util.HoneycombMR1Util.getDataProjection()     // Catch:{ Exception -> 0x00da }
            DATA_PROJECTION = r3     // Catch:{ Exception -> 0x00da }
            android.app.Activity r4 = r12.activityContext     // Catch:{ Exception -> 0x00da }
            android.database.Cursor r3 = com.google.appinventor.components.runtime.util.HoneycombMR1Util.getDataCursor(r2, r4, r3)     // Catch:{ Exception -> 0x00da }
            r10 = r3
            r12.postHoneycombGetContactEmailAndPhone(r10)     // Catch:{ Exception -> 0x00da }
            java.lang.String r3 = r0.toString()     // Catch:{ Exception -> 0x00da }
            r12.contactUri = r3     // Catch:{ Exception -> 0x00da }
            goto L_0x0088
        L_0x0074:
            android.app.Activity r2 = r12.activityContext     // Catch:{ Exception -> 0x00da }
            android.content.ContentResolver r2 = r2.getContentResolver()     // Catch:{ Exception -> 0x00da }
            java.lang.String[] r4 = PROJECTION     // Catch:{ Exception -> 0x00da }
            r5 = 0
            r6 = 0
            r7 = 0
            r3 = r0
            android.database.Cursor r2 = r2.query(r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x00da }
            r9 = r2
            r12.preHoneycombGetContactInfo(r9, r0)     // Catch:{ Exception -> 0x00da }
        L_0x0088:
            java.lang.String r2 = r12.contactName     // Catch:{ Exception -> 0x00da }
            java.lang.String r3 = r12.emailAddress     // Catch:{ Exception -> 0x00da }
            java.lang.String r4 = r12.contactUri     // Catch:{ Exception -> 0x00da }
            java.lang.String r5 = r12.phoneNumber     // Catch:{ Exception -> 0x00da }
            java.lang.String r6 = r12.contactPictureUri     // Catch:{ Exception -> 0x00da }
            ...
            java.lang.StringBuilder r7 = r7.append(r11)     // Catch:{ Exception -> 0x00da }
            java.lang.StringBuilder r2 = r7.append(r2)     // Catch:{ Exception -> 0x00da }
            java.lang.String r7 = ", email address = "
            java.lang.StringBuilder r2 = r2.append(r7)     // Catch:{ Exception -> 0x00da }
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ Exception -> 0x00da }
            java.lang.String r3 = ",contact Uri = "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ Exception -> 0x00da }
            java.lang.StringBuilder r2 = r2.append(r4)     // Catch:{ Exception -> 0x00da }
            java.lang.String r3 = ", phone number = "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ Exception -> 0x00da }
            java.lang.StringBuilder r2 = r2.append(r5)     // Catch:{ Exception -> 0x00da }
            java.lang.String r3 = ", contactPhotoUri = "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ Exception -> 0x00da }
            java.lang.StringBuilder r2 = r2.append(r6)     // Catch:{ Exception -> 0x00da }
            java.lang.String r2 = r2.toString()     // Catch:{ Exception -> 0x00da }
            android.util.Log.i(r1, r2)     // Catch:{ Exception -> 0x00da }
        ...
        L_0x00da:
            ...
            android.util.Log.i(r1, r3)     // Catch:{ all -> 0x00d8 }
            r1 = 1107(0x453, float:1.551E-42)
            r12.puntContactSelection(r1)     // Catch:{ all -> 0x00d8 }
