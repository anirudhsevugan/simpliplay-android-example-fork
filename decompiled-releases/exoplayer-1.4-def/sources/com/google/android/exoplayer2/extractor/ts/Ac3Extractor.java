...
public final class Ac3Extractor implements Extractor {
    ...
    static {
        ExtractorsFactory extractorsFactory = Ac3Extractor$$Lambda$0.b;
    }
    ...
    public final int a(ExtractorInput extractorInput, PositionHolder positionHolder) {
        int a2 = extractorInput.a(this.b.a, 0, 2786);
        if (a2 == -1) {
            return -1;
        }
        this.b.d(0);
    ...
    public final boolean a(com.google.android.exoplayer2.extractor.ExtractorInput r8) {
        /*
            r7 = this;
