...
public class trace extends ModuleBody {
    ...
    static {
        ...
        Lit5 = syntaxRules;
        SimpleSymbol simpleSymbol6 = (SimpleSymbol) new SimpleSymbol("trace").readResolve();
        Lit2 = simpleSymbol6;
        String str = "/u2/home/jis/ai2-kawa/kawa/lib/trace.scm";
        SyntaxRules syntaxRules2 = new SyntaxRules(new Object[]{simpleSymbol6}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\r\u0007\u0000\b\b", new Object[0], 1), "\u0003", "\u0011\u0018\u0004\b\u0005\u0011\u0018\f\t\u0003\u0018\u0014", new Object[]{simpleSymbol, simpleSymbol5, PairWithPosition.make(Boolean.TRUE, LList.Empty, str, 57371)}, 1)}, 1);
        Lit3 = syntaxRules2;
        SyntaxRules syntaxRules3 = new SyntaxRules(new Object[]{simpleSymbol5}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\b", new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\u0011\u0018\u0014\u0011\u0018\u001c\t\u0003\b\u000b", new Object[]{(SimpleSymbol) new SimpleSymbol("set!").readResolve(), (SimpleSymbol) new SimpleSymbol("invoke-static").readResolve(), (SimpleSymbol) new SimpleSymbol("<kawa.standard.TracedProcedure>").readResolve(), PairWithPosition.make((SimpleSymbol) new SimpleSymbol(LispLanguage.quote_sym).readResolve(), PairWithPosition.make((SimpleSymbol) new SimpleSymbol("doTrace").readResolve(), LList.Empty, str, 32806), str, 32806)}, 0)}, 2);
        Lit1 = syntaxRules3;
        trace trace2 = new trace();
        $instance = trace2;
        $Pcdo$Mntrace = Macro.make(simpleSymbol5, syntaxRules3, trace2);
        trace = Macro.make(simpleSymbol6, syntaxRules2, trace2);
        untrace = Macro.make(simpleSymbol3, syntaxRules, trace2);
        disassemble = new ModuleMethod(trace2, 1, simpleSymbol2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        trace2.run();
    }
