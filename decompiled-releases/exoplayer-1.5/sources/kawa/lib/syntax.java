...
public class syntax extends ModuleBody {
    ...
    static {
        ...
        f5synchronized = Macro.make(simpleSymbol77, new ModuleMethod(syntax, 3, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntax);
        ...
        f4import = Macro.make(simpleSymbol56, syntaxRules10, syntax);
