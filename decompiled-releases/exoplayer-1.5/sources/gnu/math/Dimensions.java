...
public class Dimensions {
    ...
    private void enterHash(int hash_code2) {
        ...
        int index = (Integer.MAX_VALUE & hash_code2) % dimensionsArr.length;
    ...
    public static Dimensions product(Dimensions a, int mul_a, Dimensions b, int mul_b) {
        ...
        Dimensions[] dimensionsArr = hashTable;
        for (Dimensions dim = dimensionsArr[(Integer.MAX_VALUE & hash) % dimensionsArr.length]; dim != null; dim = dim.chain) {
