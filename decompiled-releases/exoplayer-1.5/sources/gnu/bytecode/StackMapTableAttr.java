    ...
    public void print(ClassTypeWriter dst) {
        ...
        while (i < this.numEntries) {
            if (ipos < this.dataLength) {
                ...
                if (ipos3 <= 63) {
                ...
                } else if (ipos3 <= 127 || ipos3 == 247) {
                    classTypeWriter.println(ipos3 <= 127 ? " - same_locals_1_stack_item_frame" : " - same_locals_1_stack_item_frame_extended");
                    ...
                    int ipos4 = extractVerificationTypes(ipos2 + 2, num_locals, 0, encodedTypes2);
                    ...
                    if (ipos4 + 1 < this.dataLength) {
                        ...
                        int ipos6 = extractVerificationTypes(ipos5, num_stack, 0, encodedTypes);
