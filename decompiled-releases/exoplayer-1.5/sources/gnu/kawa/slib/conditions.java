...
public class conditions extends ModuleBody {
    ...
    static {
        ...
        SimpleSymbol simpleSymbol10 = simpleSymbol6;
        ...
        condition$Mntype$Mnfield$Mnalist = Macro.make(simpleSymbol8, syntaxRules4, conditions);
        condition$Mnref = new ModuleMethod(conditions, 7, simpleSymbol7, 8194);
        make$Mncompound$Mncondition = new ModuleMethod(conditions, 8, simpleSymbol10, -4095);
