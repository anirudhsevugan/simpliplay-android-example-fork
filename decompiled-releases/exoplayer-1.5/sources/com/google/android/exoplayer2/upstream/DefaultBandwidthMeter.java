...
import com.dreamers.exoplayercore.repack.bK;
import com.dreamers.exoplayercore.repack.bM;
import com.google.android.exoplayer2.upstream.BandwidthMeter;
import com.google.android.exoplayer2.util.Assertions;
import com.google.android.exoplayer2.util.Clock;
import com.google.android.exoplayer2.util.NetworkTypeObserver;
import com.google.android.exoplayer2.util.NetworkTypeObserver$$Lambda$0;
...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    public static final bK a = d();
    public static final bG b = bG.a(6200000L, 3900000L, 2300000L, 1300000L, 620000L);
    public static final bG c = bG.a(248000L, 160000L, 142000L, 127000L, 113000L);
    public static final bG d = bG.a(2200000L, 1300000L, 950000L, 760000L, 520000L);
    public static final bG e = bG.a(4400000L, 2300000L, 1500000L, 1100000L, 640000L);
    public static final bG f = bG.a(10000000L, 7200000L, 5000000L, 2700000L, 1600000L);
    public static final bG g = bG.a(2600000L, 2200000L, 2000000L, 1500000L, 470000L);
    private static DefaultBandwidthMeter h;
    private final bM i;
    private final BandwidthMeter.EventListener.EventDispatcher j;
    ...
    public final class Builder {
        ...
        public Builder(Context context) {
            ...
            bG c2 = DefaultBandwidthMeter.a.d(Util.a(context));
            c2 = c2.isEmpty() ? bG.a(2, 2, 2, 2, 2, 2) : c2;
            HashMap hashMap = new HashMap(8);
            hashMap.put(0, 1000000L);
            hashMap.put(2, (Long) DefaultBandwidthMeter.b.get(((Integer) c2.get(0)).intValue()));
            hashMap.put(3, (Long) DefaultBandwidthMeter.c.get(((Integer) c2.get(1)).intValue()));
            hashMap.put(4, (Long) DefaultBandwidthMeter.d.get(((Integer) c2.get(2)).intValue()));
            hashMap.put(5, (Long) DefaultBandwidthMeter.e.get(((Integer) c2.get(3)).intValue()));
            hashMap.put(10, (Long) DefaultBandwidthMeter.f.get(((Integer) c2.get(4)).intValue()));
            hashMap.put(9, (Long) DefaultBandwidthMeter.g.get(((Integer) c2.get(5)).intValue()));
            hashMap.put(7, (Long) DefaultBandwidthMeter.b.get(((Integer) c2.get(0)).intValue()));
            this.b = hashMap;
            this.c = 2000;
            this.d = Clock.a;
            this.e = true;
    ...
    public DefaultBandwidthMeter() {
        this((Context) null, bM.a(), 2000, Clock.a, false);
    }
    ...
    private DefaultBandwidthMeter(Context context, Map map, int i2, Clock clock, boolean z) {
        ...
        this.k = new SlidingPercentile(i2);
        this.l = clock;
        this.m = z;
        if (context != null) {
            ...
            this.q = a3;
            this.t = b(a3);
            DefaultBandwidthMeter$$Lambda$0 defaultBandwidthMeter$$Lambda$0 = new DefaultBandwidthMeter$$Lambda$0(this);
            a2.b();
            a2.b.add(new WeakReference(defaultBandwidthMeter$$Lambda$0));
            a2.a.post(new NetworkTypeObserver$$Lambda$0(a2, defaultBandwidthMeter$$Lambda$0));
            return;
        }
        this.q = 0;
        this.t = b(0);
    ...
    private /* synthetic */ DefaultBandwidthMeter(Context context, Map map, int i2, Clock clock, boolean z, byte b2) {
        this(context, map, i2, clock, z);
    }
    ...
    public static synchronized DefaultBandwidthMeter a(Context context) {
        ...
        synchronized (DefaultBandwidthMeter.class) {
            if (h == null) {
                ...
                h = new DefaultBandwidthMeter(builder.a, builder.b, builder.c, builder.d, builder.e, (byte) 0);
            }
    ...
    private long b(int i2) {
        Long l2 = (Long) this.i.get(Integer.valueOf(i2));
        if (l2 == null) {
    ...
    private static com.dreamers.exoplayercore.repack.bK d() {
        /*
            com.dreamers.exoplayercore.repack.bL r0 = com.dreamers.exoplayercore.repack.bK.a()
            r1 = 6
            ...
            com.dreamers.exoplayercore.repack.bL r0 = r0.b((java.lang.Object) r14, (java.lang.Object[]) r2)
            java.lang.Integer[] r2 = new java.lang.Integer[r1]
            r2[r5] = r4
            r2[r3] = r12
            r2[r7] = r12
            ...
            com.dreamers.exoplayercore.repack.bL r0 = r0.b((java.lang.Object) r6, (java.lang.Object[]) r2)
            java.lang.Integer[] r2 = new java.lang.Integer[r1]
            r2[r5] = r12
            r2[r3] = r12
            r2[r7] = r12
            ...
            com.dreamers.exoplayercore.repack.bL r0 = r0.b((java.lang.Object) r4, (java.lang.Object[]) r2)
            java.lang.Integer[] r2 = new java.lang.Integer[r1]
            r2[r5] = r10
            r2[r3] = r8
            r2[r7] = r10
            ...
            com.dreamers.exoplayercore.repack.bL r0 = r0.b((java.lang.Object) r2, (java.lang.Object[]) r1)
            com.dreamers.exoplayercore.repack.bK r0 = r0.a()
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.upstream.DefaultBandwidthMeter.d():com.dreamers.exoplayercore.repack.bK");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void a(int r10) {
        /*
            r9 = this;
            monitor-enter(r9)
            int r0 = r9.q     // Catch:{ all -> 0x0058 }
            if (r0 == 0) goto L_0x000b
            boolean r1 = r9.m     // Catch:{ all -> 0x0058 }
        ...
        L_0x000f:
            ...
            goto L_0x0056
        L_0x001b:
            long r0 = r9.b(r10)     // Catch:{ all -> 0x0058 }
            r9.t = r0     // Catch:{ all -> 0x0058 }
            com.google.android.exoplayer2.util.Clock r10 = r9.l     // Catch:{ all -> 0x0058 }
            long r0 = r10.a()     // Catch:{ all -> 0x0058 }
            int r10 = r9.n     // Catch:{ all -> 0x0058 }
            r2 = 0
            if (r10 <= 0) goto L_0x0033
            long r3 = r9.o     // Catch:{ all -> 0x0058 }
            long r3 = r0 - r3
            int r10 = (int) r3     // Catch:{ all -> 0x0058 }
            r4 = r10
            goto L_0x0034
        L_0x0033:
            r4 = 0
        L_0x0034:
            long r5 = r9.p     // Catch:{ all -> 0x0058 }
            long r7 = r9.t     // Catch:{ all -> 0x0058 }
            r3 = r9
            r3.a((int) r4, (long) r5, (long) r7)     // Catch:{ all -> 0x0058 }
            r9.o = r0     // Catch:{ all -> 0x0058 }
            r0 = 0
            r9.p = r0     // Catch:{ all -> 0x0058 }
            r9.s = r0     // Catch:{ all -> 0x0058 }
            r9.r = r0     // Catch:{ all -> 0x0058 }
            com.google.android.exoplayer2.util.SlidingPercentile r10 = r9.k     // Catch:{ all -> 0x0058 }
            java.util.ArrayList r0 = r10.d     // Catch:{ all -> 0x0058 }
            r0.clear()     // Catch:{ all -> 0x0058 }
            r0 = -1
            r10.f = r0     // Catch:{ all -> 0x0058 }
            r10.g = r2     // Catch:{ all -> 0x0058 }
            r10.h = r2     // Catch:{ all -> 0x0058 }
            monitor-exit(r9)
            return
        L_0x0056:
            monitor-exit(r9)
        ...
        L_0x0058:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.upstream.DefaultBandwidthMeter.a(int):void");
    }
    ...
    public final void a(Handler handler, BandwidthMeter.EventListener eventListener) {
        ...
        BandwidthMeter.EventListener.EventDispatcher eventDispatcher = this.j;
        Assertions.b((Object) handler);
        Assertions.b((Object) eventListener);
    ...
    public final synchronized void a(DataSpec dataSpec, boolean z, int i2) {
        if (c(dataSpec, z)) {
            this.p += (long) i2;
        }
    }
    ...
    public final synchronized void b(DataSpec dataSpec, boolean z) {
        ...
        if (c(dataSpec, z)) {
            ...
            if (i3 > 0) {
                ...
                SlidingPercentile slidingPercentile = this.k;
                ...
                if (slidingPercentile.i > 0) {
                    ...
                    int i4 = slidingPercentile.i - 1;
                    slidingPercentile.i = i4;
                    sample = sampleArr[i4];
                } else {
                    sample = new SlidingPercentile.Sample((byte) 0);
                }
                int i5 = slidingPercentile.g;
                slidingPercentile.g = i5 + 1;
                sample.a = i5;
                sample.b = sqrt;
                sample.c = f3;
                ...
                while (slidingPercentile.h > slidingPercentile.c) {
                    int i6 = slidingPercentile.h - slidingPercentile.c;
                    ...
                    if (sample2.b <= i6) {
                        ...
                        if (slidingPercentile.i < 5) {
                            ...
                            int i7 = slidingPercentile.i;
                            slidingPercentile.i = i7 + 1;
                            sampleArr2[i7] = sample2;
                        }
                    } else {
                        sample2.b -= i6;
                        slidingPercentile.h -= i6;
                    }
                }
                if (this.r >= 2000 || this.s >= 524288) {
                    SlidingPercentile slidingPercentile2 = this.k;
                    if (slidingPercentile2.f != 0) {
                        Collections.sort(slidingPercentile2.d, SlidingPercentile.b);
                        slidingPercentile2.f = 0;
                    }
                    float f4 = ((float) slidingPercentile2.h) * 0.5f;
                    int i8 = 0;
                    while (true) {
                        if (i2 < slidingPercentile2.d.size()) {
                            SlidingPercentile.Sample sample3 = (SlidingPercentile.Sample) slidingPercentile2.d.get(i2);
                            i8 += sample3.b;
                            if (((float) i8) >= f4) {
                                f2 = sample3.c;
                                break;
                            ...
                            f2 = slidingPercentile2.d.isEmpty() ? Float.NaN : ((SlidingPercentile.Sample) slidingPercentile2.d.get(slidingPercentile2.d.size() - 1)).c;
                        }
                    }
                    this.t = (long) f2;
                }
