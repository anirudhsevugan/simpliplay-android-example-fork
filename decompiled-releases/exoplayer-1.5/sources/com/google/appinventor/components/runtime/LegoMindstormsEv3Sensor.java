...
public class LegoMindstormsEv3Sensor extends LegoMindstormsEv3Base {
    ...
    public final int readInputPercentage(String functionName, int layer, int no, int type, int mode) {
        ...
        byte[] reply = sendCommand(str2, Ev3BinaryParser.encodeDirectCommand((byte) -103, true, 1, 0, "ccccccg", (byte) 27, Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) type), Byte.valueOf((byte) i3), (byte) 1, (byte) 0), true);
