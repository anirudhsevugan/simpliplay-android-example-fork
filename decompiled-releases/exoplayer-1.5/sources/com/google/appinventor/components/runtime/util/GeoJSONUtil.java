...
public final class GeoJSONUtil {
    ...
    static {
        ...
        hashMap2.put(PROPERTY_ANCHOR_HORIZONTAL.toLowerCase(), new PropertyApplication() {
        ...
        hashMap2.put(PROPERTY_ANCHOR_VERTICAL.toLowerCase(), new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.MapMarker) {
        ...
        hashMap2.put(PROPERTY_DESCRIPTION, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                feature.Description(value.toString());
            }
        });
        hashMap2.put(PROPERTY_DRAGGABLE, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                feature.Draggable(GeoJSONUtil.parseBooleanOrString(value));
            }
        });
        hashMap2.put(PROPERTY_FILL, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                int i;
        ...
        hashMap2.put(PROPERTY_FILL_OPACITY, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.HasFill) {
        ...
        hashMap2.put(PROPERTY_HEIGHT, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.MapMarker) {
        ...
        hashMap2.put(PROPERTY_IMAGE, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.MapMarker) {
        ...
        hashMap2.put(PROPERTY_INFOBOX, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                feature.EnableInfobox(GeoJSONUtil.parseBooleanOrString(value));
            }
        });
        hashMap2.put(PROPERTY_STROKE, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                int i;
        ...
        hashMap2.put(PROPERTY_STROKE_OPACITY, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.HasStroke) {
        ...
        hashMap2.put(PROPERTY_STROKE_WIDTH, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.HasStroke) {
        ...
        hashMap2.put(PROPERTY_TITLE, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                feature.Title(value.toString());
            }
        });
        hashMap2.put(PROPERTY_WIDTH, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
                if (feature instanceof MapFactory.MapMarker) {
        ...
        hashMap2.put(PROPERTY_VISIBLE, new PropertyApplication() {
            public void apply(MapFactory.MapFeature feature, Object value) {
