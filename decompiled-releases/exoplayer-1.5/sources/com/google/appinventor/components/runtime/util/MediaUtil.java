...
public class MediaUtil {
                ...
                try {
                    ...
                    try {
                        ...
                        if ((i > 0 && i2 >= 0) || (options.inSampleSize == 1 && form2.deviceDensity() != 1.0f)) {
                            ...
                            int scaledWidth = (int) (deviceDensity * ((float) i));
                            ...
                            BitmapDrawable scaledBitmapDrawable = new BitmapDrawable(form2.getResources(), Bitmap.createScaledBitmap(originalBitmapDrawable.getBitmap(), scaledWidth, (int) (deviceDensity2 * ((float) i2)), false));
    ...
    public static void loadMediaPlayer(MediaPlayer mediaPlayer, Form form, String mediaPath) throws IOException {
        String str = "android.permission.READ_MEDIA_AUDIO";
        switch (AnonymousClass3.$SwitchMap$com$google$appinventor$components$runtime$util$MediaUtil$MediaSource[determineMediaSource(form, mediaPath).ordinal()]) {
            case 1:
