...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    private boolean generateOpsForPendingActions(java.util.ArrayList<androidx.fragment.app.BackStackRecord> r5, java.util.ArrayList<java.lang.Boolean> r6) {
        /*
            ...
            r0 = 0
            monitor-enter(r4)
            java.util.ArrayList<androidx.fragment.app.FragmentManagerImpl$OpGenerator> r1 = r4.mPendingActions     // Catch:{ all -> 0x003b }
        ...
        L_0x0014:
            ...
            java.util.ArrayList<androidx.fragment.app.FragmentManagerImpl$OpGenerator> r3 = r4.mPendingActions     // Catch:{ all -> 0x003b }
            java.lang.Object r3 = r3.get(r2)     // Catch:{ all -> 0x003b }
            androidx.fragment.app.FragmentManagerImpl$OpGenerator r3 = (androidx.fragment.app.FragmentManagerImpl.OpGenerator) r3     // Catch:{ all -> 0x003b }
            boolean r3 = r3.generateOps(r5, r6)     // Catch:{ all -> 0x003b }
            r0 = r0 | r3
            int r2 = r2 + 1
            goto L_0x0014
        L_0x0026:
            java.util.ArrayList<androidx.fragment.app.FragmentManagerImpl$OpGenerator> r2 = r4.mPendingActions     // Catch:{ all -> 0x003b }
            r2.clear()     // Catch:{ all -> 0x003b }
            androidx.fragment.app.FragmentHostCallback r2 = r4.mHost     // Catch:{ all -> 0x003b }
            android.os.Handler r2 = r2.getHandler()     // Catch:{ all -> 0x003b }
            java.lang.Runnable r3 = r4.mExecCommit     // Catch:{ all -> 0x003b }
            r2.removeCallbacks(r3)     // Catch:{ all -> 0x003b }
